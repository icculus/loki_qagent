...
// Massacred for Evil Purposes by Nicholas Vining (mordred@lokigames.com)
...
//nv20001009 -- remove dependencies on kdebug
...
//nv20001009 -- remove debug dependencies
...
bool KShellProcess::start(RunMode runmode, Communication comm)
{
  ...
  if (shell.isEmpty())
    shell = searchShell();
  if (shell.isEmpty()) {
//nv20001009 -- more of the same, more of the same..
